...
french_gender_from_honorifics = {'Mr':'M', 'Mrs':'F','Miss':'F','Ms':'F','Dr':'M', 'Docteur':None, 'Doctoresse':'F' ,'Amiral':'M', 'Amirale':'F','Ambassadeur':'M', 'Ambassadrice':'F','Baron':'M','Baronne':'F', 'Brigadier':'M', 'Brigadière':'F', 'Frère':'M', 'Chanoine':None,'Capitaine':'M', 'Chef':'M', 'Cheffe' : 'F','Colonel':None,'Commandeur':None,'Commandeur & Mme':None,'Consul':'M', 'Consule':'F', 'Consul Général':'M', 'Consule Générale':'F' ,'Comte':'M','Comtesse':'F', 'Comtesse de':'F','Dame':'F', 'Député':None,'Dr & Mme':None,
...
# store into list french stopwords
french_stopwords = []
